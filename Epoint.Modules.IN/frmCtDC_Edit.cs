...
namespace Epoint.Modules.IN
{
    ...
    public partial class frmCtDC_Edit : frmVoucher_Edit
    {
        ...
        private void LoadDicName()
        {
            ...
            {
                txtTen_Kho.Text = DataTool.SQLGetNameByCode("LIHOPDONG", "Ma_Hd", "Ten_Hd", txtMa_Kho.Text.Trim());
                dicName.SetValue(txtTen_Kho.Name, txtTen_Kho.Text);
            }
            else
                txtTen_Kho.Text = string.Empty;            
        }
        ...
        {
            txtTen_Kho.Text = dicName.GetValue(txtTen_Kho.Name);
        }
        void txtMa_Kho_Validating(object sender, CancelEventArgs e)
        {
            ...
            DataRow drLookup = Lookup.ShowLookup("Ma_Kho", strValue, bRequire, "", strKeyValid);
            ...
            else
            {
                ...
                txtTen_Kho.Text = drLookup["Ten_Kho"].ToString();
